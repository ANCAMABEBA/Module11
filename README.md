...
1. **Data Preparation & Exploratory Analysis Notebook**:

https://github.com/ANCAMABEBA/Module11/blob/main/VehiclesPricesDataPrep.ipynb
3. **Modeling & Machine Learning Notebook**:  
